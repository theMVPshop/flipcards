...
export default function EditCard({
  ...
  const addCard = (id) => {
    setCards([...cards, { card_id: '', term: '', definition: '', front_img: '', back_img: '' }])
  }
          ...
          <Container>
            <Form>
                    ...
                    <div key={index}>
                      <Row className="mt-5">
                        ...
                        <Form.Group as={Col} controlId="formGridButtons">
                          ...
                          <Button className='deleteButton' variant='secondary' onClick={() => handleDelete(card.card_id, index)}>Delete</Button>
                        </Form.Group>
                      </Row>
                    </div>
                  ))}
              ...
              <Row className="align-items-center">
                <Button className='createButton' type='submit' onClick={(e) => handleEdit(e)}>Edit</Button>
              </Row>
            </Form>
          </Container>
        </Modal.Body>
