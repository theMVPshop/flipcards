      ...
      <Container className="nav">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            ...
            {checkAuth() && <Nav.Link href="/dashboard">Your Library</Nav.Link>}
          </Nav>
          {/* Appears after logged in, else Sign In appears */}
          {checkAuth() && (
            <Nav>
              <NavDropdown className="adminUser" title={user} id="collasible-nav-dropdown">
                <NavDropdown.Item href="/updateprofile" className="navbarUpdateLink">
                  Update Profile
                </NavDropdown.Item>
                <NavDropdown.Item href="/approveusers" className="navbarUpdateLink">
                  Approve Users
                </NavDropdown.Item>
